...
//go:generate mockgen -destination=mocks/storage_class_getter_mocks.go -package=mocks github.com/dell/csm-metrics-powerstore/internal/k8s StorageClassGetter
...
func (f *StorageClassFinder) isMatch(class v1.StorageClass) bool {
	...
	systemID, systemIDExists := class.Parameters["arrayID"]
